...
for i = 1:5    
    ...
    coef = gamma{i}{1};
    plot(x_,coef(1) + coef(2)*(x_-x0) + coef(3)*(x_-x0).^2 + coef(4)*(x_-x0).^3,'LineWidth',2,'color',[0 0 1])
    x0 = r{i}(1);
...
for i = 1:5
    line([p{i}(1) q{i}(1)],[p{i}(2) q{i}(2)],'LineWidth',2,'color',[0 0 1])
    line([s{i}(1) v{i}(1)],[s{i}(2) v{i}(2)],'LineWidth',2,'color',[0 0 1])
end
% finish line
line([896 977],[622 622],'LineWidth',2,'color',[0.5 0.5 0.5])
axis([0 1024 0 1100])
